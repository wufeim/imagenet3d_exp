...
def worker(params):
    ...
    save_img_path = os.path.join(args.save_path, split, 'images', cate)
    save_annot_path = os.path.join(args.save_path, split, 'annotations', cate)
    save_list_path = os.path.join(args.save_path, split, 'lists', cate)
